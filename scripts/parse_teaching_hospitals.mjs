...
const html = fs.readFileSync(path.resolve(__dirname, '../teaching_raw.html'), 'utf-8');
...
fs.writeFileSync(path.resolve(__dirname, '../teaching_hospitals.json'), JSON.stringify(hospitals, null, 2));

console.log('Successfully extracted teaching hospitals data.'); 